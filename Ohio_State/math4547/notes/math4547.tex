...
In this lecture, we will use the axioms to deduce various properties of the real numbers $\mathbb{R}$. From these axioms, we can derive many more properties of the real numbers.
...
\begin{definition}
    ...
    \begin{itemize}
        ...
        \item For all $a, b, c \in \mathbb{R}$, $a \times (b \times c) = (a \times b) \times c$.
